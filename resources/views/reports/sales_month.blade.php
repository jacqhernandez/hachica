...
<div class="panel-heading">
	Sales for the month of <span style="color: #3097d1;">{{ Carbon\Carbon::now()->format('F Y') }}</span>
</div>
<div class="panel-body sales-details">
	<div>
		Total Sales: &#8369;{{ $total_sales_month }}<br>
		Total Transactions: {{ $sales_month->count() }}<br>
		Total Items Sold: {{ $total_items_sold_month }}
	</div>		
</div>
